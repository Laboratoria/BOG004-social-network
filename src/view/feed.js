...
export default () => {
  ...
  getRecipes().then((recipes) => {
    ...
    <div class="box-recipe">
      ...
      <div class= 'iconos'>
      <img id= 'likeImg' src='../img/like.png' alt='like_image'><p class='likeText'>Me gusta</p>
      <img id= 'espatulaImg' src='../img/espatula.png' alt='espatula_image'><p class='eliminarText'>Eliminar</p>
      <img id= 'rodilloImg' src='../img/rodillo.png' alt='rodillo_image'><p class='editarText'>Editar</p>
      </div>
