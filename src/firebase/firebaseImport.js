...
export { getFirestore, collection, addDoc, query, getDocs, serverTimestamp, orderBy, onSnapshot, updateDoc, doc, deleteDoc, arrayUnion, arrayRemove } from 'https://www.gstatic.com/firebasejs/9.6.9/firebase-firestore.js';
