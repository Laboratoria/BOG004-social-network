...
export { getFirestore, collection, addDoc, query, getDocs, serverTimestamp, orderBy, onSnapshot } from 'https://www.gstatic.com/firebasejs/9.6.9/firebase-firestore.js';
